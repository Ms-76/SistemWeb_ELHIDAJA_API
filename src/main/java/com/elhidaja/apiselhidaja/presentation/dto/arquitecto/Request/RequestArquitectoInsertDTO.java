...
@AllArgsConstructor
@NoArgsConstructor
@JsonPropertyOrder({ "idLogin", "nombres", "numeroDocumento", "idDocumentoIdentidad", "direccion", "telefono",
        "email", "idDistrito", "especialidad" })

public class RequestArquitectoInsertDTO {
