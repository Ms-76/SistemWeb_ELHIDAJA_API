...
@AllArgsConstructor
@NoArgsConstructor
@JsonPropertyOrder({ "idLogin","id", "nombres", "numeroDocumento", "idDocumentoIdentidad", "direccion", "telefono", "email", "idDistrito", "especialidad" })
public class RequestArquitectoUpdateDTO {
    ...
    @LengthSQL(tabla = "arquitecto", columna = "especialidad")
